...
<div id="crash-control-1"
  class="sc-hLVXRe cYiOHZ game-control {$app.screen < 1100 ? 'mobile-view' : 'style1'}">
    ...
    {#if activePanel === 1}
      ...
      {#if $crashGameType === 1}
        <div class="sc-eqUgKp iuHOYP">
          ...
          <div class="forms {$app.screen < 1100 ? 'mobile-view' : ''}">
            <div
      ...
      {:else}
        <div
          class="sc-kMyqmI jDBJMt manual-control {$app.screen < 1100
            ? 'mobile-view'
            : ''}"
        >
          <div
