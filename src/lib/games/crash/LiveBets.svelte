...
<div class="sc-czvZiG gnytwz  {$app.newScreen < 1100 ? "mobile-view" : ""}">
  {#if $app.screen > 1100}
    <div class="top">
              ...
              {#each players as player (player.userId)}
                <tr>
                  <td class="user">
                    ...
                    href={`${$app === "/" ? "" : $app}/?tab=profile&id=${player.userId}`}>
              ...
              <tbody>
                {#each redList as bet, index (`${bet.userId}_${index}`)}
                  <tr>
                    <td> 
                      <a class="sc-jUosCB iTDswZ user-info"
                      href={`${$app === "/" ? "" : $app}/?tab=profile&id=${bet.user_id}`}>
              ...
              <tbody>
                {#each greenList as bet, index (`${bet.userId}_${index}`)}
                  <tr>
                    <td>
                      <a class="sc-jUosCB iTDswZ user-info"
                        href={`${$app === "/" ? "" : $app}/?tab=profile&id=${bet.user_id}`}><img
